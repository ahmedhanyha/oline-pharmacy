...
<div class="blog_datails">
  <div class="container">
    <div class="row">
      <div class="col-lg-9">
        <div class="head">
          <h2 class="h1"> <?php echo $fet["title"] ?>
          </h2>
          <p class="category"> <span class="data"> Posted: <?php echo $fet["data"] ?>  </span> Categories: <span class="category_inside" id="category_inside">   </span> </p>
        </div>
        <div class="img">
          <img src="../admin/php_code/upload/avatar/<?php echo $fet["image"] ?>" alt="">
        </div>
      ...
      <div class="col-lg-3">
        <div class="right">
          ...
          <h2 class="h1"> Categories </h2>
              <div class="list-group" style="width:88%" id="blog_category">
      ...
      <div class="container">
          <div class="row">
              <div class="footer_item col-lg-4 col-sm-6 col-12">
                  ...
                  <div class="footer_desc">Lorem ipsum dolor sit amet, consectetur adipi scing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>
                  <div class="footer_desc">Ut enim ad minim veniam, quis nostrud exeri itation ullamco laboris nisi ut aliquip ex ea commodo consequat.</div>
              </div><!-- ./footer_item -->
              <div class="footer_item col-lg-4 col-sm-6 col-12">
              ...
              <div class="footer_item col-lg-2 col-md-3 col-sm-6 col-12">
                  <div class="footer_title"><h3>information</h3></div>
                  <ul class="footer_list">
                      <li><a href="about.html"  class="footer_link footer_desc">About us</a></li>
              ...
              <div class="footer_item col-lg-2 col-md-3 col-sm-6 col-12">
                  <div class="footer_title"><h3>quick links</h3></div>
                  <ul class="footer_list">
      ...
      <div class="container">
          <div class="row justify-content-center">
              <div class="footer_item col-lg-6">
                  <div class="footer_logo footer_payment"><img src="assets/image/index/small_img/payment-footer.jpg" alt=""></div>
              </div><!-- ./footer_item -->
              <div class="footer_item col-lg-6">
                  <p class="footer_desc">Medisine © 2020. All Rights Reserved. Designed by <a href="#">MagenTech.Com</a></p>
              </div><!-- ./footer_item -->
          </div><!-- ./row -->
      </div><!-- ./container -->
  </div><!-- ./bottom_footer -->
...
<script src="front_code/blog_details.js"></script>


<script src="front_code/blog.js"></script>
