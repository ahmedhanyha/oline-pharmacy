...
include("../connection.php");
    ...
    {
        $ins = $con->prepare("INSERT INTO `registrations`(first_name,last_name,email,age,phone,`password`,confirm_password,`status`,`image`)  VALUE(:first_name,:last_name,:email,:age,:phone,:password,:confirm_password,'2',:image)");
