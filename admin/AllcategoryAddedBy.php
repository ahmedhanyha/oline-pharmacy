...
<div class="content">
    ...
    <div class="manage">
        <h2 class="h1 text-center"> ALL Category Added By <?php echo $fet["first_name"] ?> <?php echo $fet["last_name"]?> </h2>
    </div>
...
<input type="hidden" name="admincategory" id="admincategory" value="<?php echo $_GET["id"] ?>">
...
<script src="php_code/categoryaddedby.js"></script>