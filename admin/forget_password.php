...
<div class="header">
    <div class="container">
         <h2 class="h1 text-center"> Customer forget password </h2>
    </div>
</div>
...
<div class="reistration text-center login">
    <div class="container">
        ...
        <h2 class="h1"> Forget Password Customers </h2>

        <p class="addres"> If you forget a password . </p>
...
<script src="php_code/forget_password1.js"></script>